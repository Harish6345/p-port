...
const About = () => {
  useEffect(() => {
    // Type annotations for parameters are updated to use the GSAP default types
    const animateSection = (selector: string, fromVars: gsap.TweenVars, toVars: gsap.TweenVars): void => {
